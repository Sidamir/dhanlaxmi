...
<head>
  ...
  <title>Pass Details | Sanskrutik Mahotsav</title>
  <!-- FAVICONS ICON -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pass Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">DataTable with pass</h3>
            </div>
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Authenticate/delete_pass_details')?>/"+id,
            type: "POST",
            dataType: "JSON",
