...
<head>
  ...
  <title>Testimonials | ixiLoan</title>
  <!-- FAVICONS ICON -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Testimonials_controller/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Testimonials_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            if(data.image)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'upload/testimonials/'+data.image+'" class="img-fluid">'); // show photo
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Testimonials_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Testimonials_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Testimonials_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
