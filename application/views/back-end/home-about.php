...
<head>
  ...
  <title>Home About | ixiLoan</title>
  <!-- FAVICONS ICON -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Homeabout_controller/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Homeabout_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Homeabout_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Homeabout_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Homeabout_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
