...
<head>
  ...
  <title>Our Mission Tab | ixiLoan</title>
  <!-- FAVICONS ICON -->
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Our Mission Tab</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin-dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Our Mission Tab</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Our_mission_tab_controller/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Add Our Mission Tab'); // Set Title to Bootstrap modal title
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Our_mission_tab_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            if(data.image)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'upload/our-mission-tab/'+data.image+'" class="img-fluid">'); // show photo
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Our_mission_tab_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Our_mission_tab_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Our_mission_tab_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
