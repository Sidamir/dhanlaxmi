...
<head>
  ...
  <title>Upcoming Events | Sanskrutik Mahotsav</title>
  <!-- FAVICONS ICON -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Upcoming_events/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Add Upcoming Events'); // Set Title to Bootstrap modal title
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Upcoming_events/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="open_for"]').val(data.open_for);
            $('[name="venue"]').val(data.venue);
            $('[name="stime"]').val(data.stime);
            $('[name="etime"]').val(data.etime);
            $('[name="fdate"]').val(data.fdate);
            $('[name="tdate"]').val(data.tdate);
            $('[name="audition"]').val(data.audition);

            
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Upcoming Events'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Upcoming_events/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Upcoming_events/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Upcoming_events/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
              ...
              <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Orgonizer</label>
                            <div class="col-md-12">
                                <input name="sub_title" placeholder="Orgonizer" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="title" placeholder="Phone" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="desig" placeholder="Eamil" class="form-control" type="email">
                                <span class="help-block"></span>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            <label class="control-label col-md-3">Open For</label>
                            <div class="col-md-12">
                                <input name="open_for" placeholder="Open For" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="fdate" placeholder="From Date" class="form-control" type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="tdate" placeholder="To Date" class="form-control" type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3">Audition</label>
                            <div class="col-md-12">
                                <input name="audition" placeholder="Audition" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
