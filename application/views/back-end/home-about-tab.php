...
<head>
  ...
  <title>Home About Tab | ixiLoan</title>
  <!-- FAVICONS ICON -->
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Home About Tab</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin-dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Home About Tab</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('HomeaboutTab_controller/ajax_list')?>",
            "type": "POST" 
        },
...
function edit_person(id) 
{
    ...
    $.ajax({
        url : "<?php echo site_url('HomeaboutTab_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="id"]').val(data.id);
            $('[name="title"]').val(data.home_about_tab_title);
            $('[name="desig"]').val(data.home_about_tab_decrepitation);
            ...
            if(data.image)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'upload/homeaboutTab/'+data.image+'" class="img-fluid">'); // show photo
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('HomeaboutTab_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('HomeaboutTab_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('HomeaboutTab_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLongTitle">Home About Tab</h5>
