...
<head>
  ...
  <title>Why Choose us | ixiLoan</title>
  <!-- FAVICONS ICON -->
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>back_end_assets/summernote/summernote-bs4.css">
</head>

  <style type="text/css">
	.card-primary:not(.card-outline)>.card-header { background-color: #e31e24; } .btn-primary { color: #fff; background-color: #e31e24; border-color: #e31e24; box-shadow: none; border-radius: 1px; } .btn-primary:hover { color: #fff; background-color: #000; border-color: #e31e24; box-shadow: none; border-radius: 1px; } .page-item.active .page-link { z-index: 1; color: #fff; background-color: #e31e24; border-color: #e31e24; } .sidebar-dark-primary .nav-sidebar>.nav-item>.nav-link.active, .sidebar-light-primary .nav-sidebar>.nav-item>.nav-link.active { background-color: #e31e24; color: #fff; } a { color: #e31e24; }
  </style>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Why_choose_us_controller/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Add Why Choose us'); // Set Title to Bootstrap modal title
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Why_choose_us_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="desig"]').val(data.desig);
            
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Why Choose us'); // Set title to Bootstrap modal title
            $('#photo-preview').show(); // show photo preview modal
            if(data.image)
            {
                $('#label-photo').text('Change Photo'); // label photo upload
                $('#photo-preview div').html('<img src="'+base_url+'upload/why-choose-us/'+data.image+'" class="img-fluid">'); // show photo
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Why_choose_us_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Why_choose_us_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Why_choose_us_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLongTitle">Why Choose Us</h5>
              ...
              <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <!-- <input name="desig" placeholder="Description" class="form-control" type="text"> -->
                                <textarea name="desig" id="summernote" rows="4" cols="59"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<script src="<?php echo base_url(); ?>back_end_assets/summernote/summernote-bs4.min.js"></script>
<script>
  $(function () {
    // Summernote
