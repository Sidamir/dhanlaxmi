...
<head>
  ...
  <title>Our Vision | ixiLoan</title>
  <!-- FAVICONS ICON -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('Our_vision_controller/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Add Our Vision'); // Set Title to Bootstrap modal title
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Our_vision_controller/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Our Vision'); // Set title to Bootstrap modal title
            $('#photo-preview').show(); // show photo preview modal
            if(data.image)
            {
                $('#label-photo').text('Change Photo'); // label photo upload
                $('#photo-preview div').html('<img src="'+base_url+'upload/our-vision/'+data.image+'" class="img-fluid">'); // show photo
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('Our_vision_controller/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Our_vision_controller/ajax_update')?>";
    } 
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Our_vision_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
