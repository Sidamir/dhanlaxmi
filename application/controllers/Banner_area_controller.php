...
class Banner_area_controller extends CI_Controller {  
	public function __construct()
	{ 
		parent::__construct();
		$this->load->model('Banner_area_model','slider');
	...
	public function index()
	{
		if($this->session->userdata('admin_username') != ''){	 
			...
			$rows['menu_name'] = array('name' => 'banner_area', 'sub_name' => 'main');  
			// $rows['rows_values'] = $this->User_model->selectdata_asc('tbl_shipping_type');
			$this->load->view('back-end/banner-area',$rows); 
		}else{
